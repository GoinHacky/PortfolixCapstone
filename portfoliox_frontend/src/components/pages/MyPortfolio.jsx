        ...
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-slate-950/70 backdrop-blur-sm p-4 md:p-8">
          <div className="relative w-full max-w-4xl overflow-hidden rounded-3xl bg-white shadow-2xl ring-1 ring-white/10 dark:bg-slate-900">
            ...
            <div className="relative z-20 max-h-[90vh] overflow-y-auto">
              <header className="bg-gradient-to-br from-[#2E0000] via-[#3B0000] to-[#4A0000] px-8 pb-10 pt-12 text-white sm:px-12">
                ...
                {statCards.length > 0 && (
                  <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                    {statCards.map((stat) => (
                      <div
                        key={stat.label}
                        className="rounded-2xl border border-white/20 bg-gradient-to-br from-[#2E0000]/85 via-[#3F0000]/80 to-[#4A0000]/75 px-5 py-4 shadow-lg shadow-[#120202]/40 backdrop-blur"
                      >
                        <div className="text-xs font-semibold uppercase tracking-widest text-[#FBE7B0]">
                          {stat.label}
                        </div>
                ...
                <section className="grid gap-10 lg:grid-cols-[minmax(0,1.5fr)_minmax(0,1fr)] lg:items-start">
                  <div className="space-y-8">
                    <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-lg shadow-slate-900/5 dark:border-slate-700 dark:bg-slate-900/60">
                      <div className="flex items-center gap-3 text-[#4A0000] dark:text-[#F3D996]">
                      ...
                      <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-lg shadow-slate-900/5 dark:border-slate-700 dark:bg-slate-900/60">
                        ...
                        <div className="mt-4 flex flex-wrap gap-2">
                          {skillNames.map((skill) => (
                            <span
                              key={skill}
                              className="inline-flex items-center gap-2 rounded-full border border-[#4A0000]/35 bg-gradient-to-r from-[#2E0000] via-[#3B0000] to-[#4A0000] px-4 py-2 text-xs font-semibold uppercase tracking-wide text-[#FBE7B0] shadow-sm dark:border-[#F3D996]/30 dark:from-[#5c3d03] dark:to-[#8d5f0f] dark:text-[#FCE7BA]"
                            >
                            ...
                            <ul className="mt-4 space-y-2 text-sm text-slate-700 dark:text-slate-200">
                              {projectNames.map((name, idx) => (
                                <li key={idx} className="flex gap-3">
                                  <span className="mt-1 inline-flex h-1.5 w-1.5 flex-shrink-0 rounded-full bg-[#4A0000] dark:bg-[#F3D996]" />
                                  <span>{name}</span>
                                </li>
                              ))}
                      ...
                      <div className="mt-5 space-y-4">
                        {quickFacts.map(({ icon: Icon, label, value, href }) => (
                          <div key={label} className="flex items-start gap-3 text-sm text-slate-700 dark:text-slate-200">
                            <div className="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-[#4A0000]/12 text-[#4A0000] dark:bg-[#F3D996]/10 dark:text-[#F3D996]">
                            ...
                            <div>
                              ...
                              {href && value !== 'Not provided' ? (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="mt-1 inline-flex items-center gap-2 text-sm font-semibold text-[#4A0000] underline transition hover:text-[#2E0000] dark:text-[#F3D996]"
                                >
                          ...
                          {hasCertificateImage && certificateImageUrl ? (
                            <figure className="overflow-hidden rounded-xl border border-slate-200 bg-slate-50 shadow-sm transition hover:-translate-y-1 hover:shadow-lg dark:border-slate-700 dark:bg-slate-800">
                              ...
                              <figcaption className="flex items-center justify-between px-4 py-3 text-xs text-slate-600 dark:text-slate-300">
                                ...
                                <button
                                  onClick={() => setPreviewImage(certificateImageUrl)}
                                  className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#2E0000] via-[#3B0000] to-[#4A0000] px-3 py-1 text-[11px] font-semibold uppercase tracking-wide text-white shadow md:text-xs"
                                >
                                  View Full
                                </button>
                              </figcaption>
                              ...
                              {certificatePath && (
                                <div className="mt-2">
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center gap-2 text-sm font-semibold text-[#4A0000] underline hover:text-[#2E0000] dark:text-[#F3D996]"
                                  >
                  ...
                  <div className="flex flex-wrap gap-3">
                    {viewPortfolio.githubLink && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 rounded-full border border-[#4A0000] px-5 py-2 text-sm font-semibold text-[#4A0000] transition hover:bg-[#4A0000] hover:text-white dark:border-[#F3D996] dark:text-[#F3D996] dark:hover:bg-[#F3D996] dark:hover:text-slate-900"
                      >
                        <Link2 className="h-4 w-4" />
                        Open GitHub project
                      </a>
                    ...
                    <button
                      onClick={() => setViewPortfolio(null)}
                      className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#2E0000] via-[#3B0000] to-[#4A0000] px-5 py-2 text-sm font-semibold text-white shadow-lg transition hover:brightness-110 dark:bg-[#F3D996] dark:text-slate-900 dark:hover:bg-[#f7d36a]"
                    >
                      Close Overview
                    </button>
