                            ...
                            <div>
                              ...
                              {href && value !== 'Not provided' ? (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="mt-1 inline-flex items-center gap-2 text-sm font-semibold text-[#800000] underline transition hover:text-[#5a0000] dark:text-[#D4AF37]"
                                >
                              ...
                              {certificatePath && (
                                <div className="mt-2">
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center gap-2 text-sm font-semibold text-[#800000] underline hover:text-[#5a0000] dark:text-[#D4AF37]"
                                  >
